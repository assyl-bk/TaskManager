...
const updateTaskStatus = async (req, res) => {
    try {
        ...
        // Make sure it's an array (if it's a single ObjectId, wrap it)
        const assignedArray = Array.isArray(assignedTo) ? assignedTo : assignedTo ? [assignedTo] : [];

        const isAssigned = assignedArray.map(id => id.toString()).includes(req.user._id.toString());
...
const updateTaskChecklist = async (req, res) => {
    try {
        ...
        //Auto-mark task as completed if all checklist items are done(checked)
...
const getDashboardData = async (req, res) => {
    try {
        ...
        //Ensure all possibile status are included
...
//@desc: Get user-specific dashboard data (User)
